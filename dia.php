...
<input type="submit" name="boton" value="enviar">
	...
	if ($fecha!="")
	{
		...
		$conex=conectar();
		$comando="
SELECT usuario.num_identificacion, usuario.nombre, usuario.apellido,usuario.tipo_usuario,usuario.grado, usuario.direccion,   usuario.telefono_celular
FROM usuario INNER JOIN prestamo ON usuario.num_identificacion = prestamo.num_identificacion
WHERE (((prestamo.fecha_prestamo)='$fecha'));";
