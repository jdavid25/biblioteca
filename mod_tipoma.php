...
<div id="content">
    ...
    <div id="content_left" style="height: 444px; width: 170px">
        ...
        <div class="content_left_section" style="height: 341px; width: 215px">
            ...
            <div id='cssmenu'>
<ul>
    <li class='active' style="height: 19px"><a href='mod_usuario.php'><span>Usuario</span></a></li>
	<li class='active' style="height: 19px"></li>
	<li class='active' style="height: 19px"></li>
    ...
    <div id="content_right" class="auto-style2">
        ...
        <div class="margin_bottom_40">
			...
			<form action="mod_tipoma.php" method="POST" style="height: 103px">
<table  class="auto-style5"bgcolor="#CCCCCC"align="center" style="width: 76%; height: 157px;">
	<tr>
		<td style="width: 556px" class="auto-style3"><br class="auto-style3" />
		<span class="auto-style3">&nbsp;Codigo Tipo De Material</span></td>
		<td><br />
		<input type="text" name="cod" onKeyPress="return validarnum(event)"  placeholder="Solo numeros" required="required"/></td>
	</tr>
	<tr>
		<td style="width: 556px" class="auto-style3">&nbsp;<br />
		&nbsp;Nuevo Nombre Tipo De Material</td>
		<td><br />
		<input type="text" name="ma" class="auto-style1" onKeyPress="return validartexto(event)" placeholder="Solo texto" required="required"/></td>
	</tr>
	<tr>
		<td  colspan="2" style="width: 556px" align="center"a>
		<br />
<input class="boton" type="submit" value="modificar" name="elim"/><br />
		</td>
		<td>&nbsp;</td>
	</tr>
</table>
...
if ($ma!="")
{
$comando="UPDATE tipo_material set tipo_material='$ma' where codigo_material='$codigo';";
