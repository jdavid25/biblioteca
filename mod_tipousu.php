...
<ul>
    ...
    <div id="content_right" class="auto-style2">
        ...
        <div class="margin_bottom_40">
				<form action="mod_tipousu.php" method="POST">
	<table  bgcolor="#CCCCCC"class="auto-style5" align="center" style="width: 73%; height: 153px;">
		<tr>
			<td class="auto-style3"><br />
			&nbsp;Codigo Tipo De Usuario</td>
			<td><input type="text" name="cod" onKeyPress="return validarnum(event)"  placeholder="Solo numeros" required="required"/></td>
		</tr>
		<tr>
			<td class="auto-style3" style="height: 19px"><br />
			&nbsp;Nuevo Nombre De Tipo De Usuario</td>
			<td style="height: 19px"><input type="text" name="usu" onKeyPress="return validartexto(event)" placeholder="Solo texto" required="required"/></td>
		</tr>
		<tr>
			<td colspan="2" align="center">
<input type="submit" value="Modificar" class="auto-style4" name="elim" style="height: 37px"/></td>
...
if ($usu!="")
{
$comando="UPDATE tipo_usuario set detalle_usuario='$usu' where codigo='$codigo';";
