...
<div id="menu_wrapper">    
    <div id="menu">
        <ul>
            ...
            <li><a href="anadir.php" style="visibility: visible">Añadir</a></li>
...
<ul>
    ...
    <div id="content_right" class="auto-style2">
        ...
        <div class="margin_bottom_40">
			...
			<table align="center" style="width: 76%; height: 166px;" border="0"  bgcolor="#CCCCCC" class="auto-style4" >
		<tr>
			<td class="auto-style3" style="height: 48px">&nbsp; Codigo Usuario</td>
			<td style="height: 48px">
			<input type="text" name="codusu" onKeyPress="return validarnum(event)"  placeholder="Solo numeros" required="required"/></td>
		</tr>
	</td>
		</tr>
		<tr>
			...
			&nbsp;Nuevo Usuario </td>
			<td style="height: 18px"><input type="text" name="usu" onKeyPress="return validartexto(event)"  placeholder="Solo texto" required="required"/></td>
		</tr>
					<tr>
