...
<table class="auto-style3" align="center" bgcolor="#CCCCCC" style="width: 50%; height: 152px;">
	<tr>
		<td class="auto-style4" style="height: 18px"><br />
		<form action="tipomaterial.php" method="post">
&nbsp;Codigo material</td>
		<td style="height: 18px"><input type="text" name="codma" onKeyPress="return validarnum(event)"  placeholder="Solo numeros" required="required"/></td>
	</tr>
	<tr>
		<td class="auto-style4"><br />
&nbsp;Nuevo material</td>
		<td><input type="text" name="ma" onKeyPress="return validartexto(event)" placeholder="Solo texto" required="required"/></td>
	</tr>
	<tr>
		<td  align="center" colspan="2">
		<br />
<input class="boton" type="submit" value="enviar" style="width: 112px; height: 42px" /><br />
...
$codma=$_POST["codma"];
$ma=$_POST["ma"];
$comando="INSERT INTO tipo_material (codigo_material,tipo_material) 
value('$codma','$ma');";
