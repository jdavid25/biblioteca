...
<ul>
    ...
    <div id="content_right" class="auto-style2">
        ...
        <div class="margin_bottom_40">
			...
			<form action="modtipoma.php" method="POST" style="height: 103px">
<table  class="auto-style4"bgcolor="#CCCCCC"align="center" style="width: 67%">
	<tr>
	...
	<tr>
		...
		<td><br />
		<input type="text" name="ma" class="auto-style1" /></td>
	</tr>
	<tr>
		<td  colspan="2" style="width: 556px" align="center"a>
		<br />
<input class="boton" type="submit" value="modificar" name="elim"/></td>
		<td>&nbsp;</td>
	</tr>
</table>
	<br>
